...
class MeetingViewModel(private val meetingRepository: MeetingRepository) : ViewModel() {
    ...
    // New method for creating meeting with auto-generated Google Meet link
    fun createMeetingWithAutoMeet(
        title: String,
        description: String,
        startTime: String,
        endTime: String,
        ...
        viewModelScope.launch {
            ...
            _createMeetingState.value = meetingRepository.createMeetingWithAutoGeneratedLink(
                title, description, startTime, endTime, participants, participantEmails
            )
        }
    }
